...
export const CONTRACT_SPECS: ContractSpec[] = [
  ...
  },
  {
    ...
    months: ['Dec Z · 700.00', 'Jan F · 697.50', 'Feb G · 695.25', 'Mar H · 693.00', 'Apr J · 691.00'],
    curve: 'backwardation — Europe’s diesel benchmark',
  ...
  },
  {
    ...
    months: ['Dec Z · 2.05', 'Jan F · 2.03', 'Feb G · 2.02', 'Mar H · 2.04', 'Apr J · 2.19'],
    curve: 'watch the Apr jump — the SUMMER-SPEC break, a seasonality no crude curve has',
  ...
  },
  {
    ...
    months: ['Jan F · 4,800', 'Mar H · 4,760', 'May K · 4,720', 'Jul N · 4,690', 'Sep U · 4,665'],
    curve: 'backwardation — a tight market pays for coffee NOW (the course’s trading backdrop)',
