...
const topic: Topic = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'One Word, Four Contracts: Arabica · Cotton · Brent · Sugar',
      body: `"Futures contract" is one legal form wrapped around very different physical realities. Flip through the four tabs below and compare the same rows each time — the **next five listed delivery months** (note who trades in contango and who in backwardation, and that Brent lists *every* month while Sugar lists only four a year), then the **origin spec**, **quality spec**, **delivery points** and **Incoterm**.\n\nThe spread is the lesson: Cotton is **US-grown only**; Sugar accepts **~28 origins** and delivers **FOB the buyer's vessel at the origin port** (the buyer charters the ship!); Coffee delivers a **graded warehouse warrant** in the US or Europe; and Brent delivers **nothing at all** — it cash-settles against an index. Before trading any contract, read its rulebook: the word "futures" tells you almost nothing about what you would actually receive.`,
